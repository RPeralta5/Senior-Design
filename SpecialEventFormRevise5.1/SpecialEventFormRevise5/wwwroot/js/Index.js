...
$(Document).ready(function () {
    $("input").keyup(function () {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// Radio Buttons
        // All radioButton Groups into a list
        radioGroups = [];
        ...
        //*/alert("Total number of radio button groups visible or not: " + radioGroups.length);
        ...
        //alert("Your here1");
        // All distinct and visible radio button groups into a list
        var allDistinctVisibleRadioGroups = [];
        for (var i = 0; i < radioGroups.length; i++) {
            ...
            for (var j = 0; j < group.length; j++) {
                ...
                if (!group[j].hidden) {//checks is radiobutton is hidden
                    //alert("Radio button group " + radioGroups[i] + " is not hidden.");
                    if (!allDistinctVisibleRadioGroups.includes(radioGroups[i])) // checks for duplicates
                    {
                        allDistinctVisibleRadioGroups.push(radioGroups[i]);
                    }
                }
            }
        }
        //alert("Total number of radio button groups: " + allDistinctVisibleRadioGroups.length);

        // A string with all the distinct radio groups that are visible
        var x = "";
        for (var i = 0; i < allDistinctVisibleRadioGroups.length; i++) {
            x += " " + allDistinctVisibleRadioGroups[i].toString();
        }
        //alert("Total radio button groups that are visible: \n" + x);

        //alert("Number of radio button groups: " + allDistinctVisibleRadioGroups.length);

        //alert("Your here 2");

        var numberOfRadioGroupsFilled = 0;
        for (i = 0; i < allDistinctVisibleRadioGroups.length; i++) {
            var groupName = document.getElementsByName(allDistinctVisibleRadioGroups[i]);
        ...
        // All distinct checkbox groups into a list
        checkboxGroups = [];
        ...
        */
        ...
        //alert("Your here1");
        var allDistinctVisibleCheckBoxGroups = [];  // All distinct visible checkbox groups
        for (var i = 0; i < checkboxGroups.length; i++) {
            ...
            for (var j = 0; j < group.length; j++) {
                ...
                if (!group[j].hidden) {//checks is checkbox button is hidden
                    //alert("checkbox button group " + checkboxGroups[i] + " is not hidden.");
                    atLeastOneChecked = true;
                    if (!allDistinctVisibleCheckBoxGroups.includes(checkboxGroups[i])) {// checks for duplicates
                        allDistinctVisibleCheckBoxGroups.push(checkboxGroups[i]);
                    }
                }
            }
        }
        //alert("Total number of distinct checkbox button groups: " + allDistinctVisibleCheckBoxGroups.length);
        /*
        var x = "";
        for (var i = 0; i < allDistinctVisibleCheckBoxGroups.length; i++) {
            x += " " + allDistinctVisibleCheckBoxGroups[i].toString();
        }
        */
        //alert("Total checbox button groups that are visible: \n" + x);

        //alert("Number of checkbox button groups: " + allDistinctVisibleCheckBoxGroups.length);

        //alert("Your here 2");

        var numberOfCheckboxGroupsFilled = 0;
        for (i = 0; i < allDistinctVisibleCheckBoxGroups.length; i++) {
            var groupName = document.getElementsByName(allDistinctVisibleCheckBoxGroups[i]);
        ...
        $("input[type='text']:enabled:visible").each(function () {
            if ($(this).val() != "") {
                numOfTextsNotNull++;
        ...
        $("input[type='number']:enabled:visible").each(function () {
            if ($(this).val() != "") {
                numOfNumbersNotNull++;
        ...
        $("input[type='date']:enabled:visible").each(function () {
            if ($(this).val() != "") {
                numOfDatesNotNull++;
        ...
        /*
        alert("There are a total of VisibleDates" + allDistinctVisibleRadioGroups.length + "\n" +
            "There are a total of VisibleNumbers" + allDistinctVisibleCheckBoxGroups.length + "\n" +
        ...
        var userTotalInput = numberOfRadioGroupsFilled + numberOfCheckboxGroupsFilled +
            ...
            numOfDatesNotNull + numOfTextareasNotNull;
        var totalInputsAvailable = allDistinctVisibleRadioGroups.length + allDistinctVisibleCheckBoxGroups.length +
            totalNumberOfVisibleEnabledTexts + totalNumberOfVisibleEnabledNumbers +
            totalNumberOfVisibleEnabledDates + totalNumberOfVisibleEnabledTextareas;

        $(Document).ready(function () {
            //*/var totalInputsAvailable = $("input").length;
            $("input").keyup(
                function () {
...
function nameInsuredOtherFunction() {
    ...
    if (checkBox.checked == true) {
        ...
        document.getElementById("NameInsuredOtherInputText").hidden = false;
        ...
        document.getElementById("NameInsuredOtherInputText").hidden = true;
...
function admissionCharge() {
    ...
    if (admissionOptions[0].checked) {
        ...
        document.getElementById("admissionChargeSection").hidden = false;
        ...
        document.getElementById("sellTicketsSection").hidden = false;
    ...
    if (admissionOptions[1].checked) {
        ...
        document.getElementById("admissionChargeSection").hidden = true;
        ...
        document.getElementById("sellTicketsSection").hidden = true;
        document.getElementById("sellTicketsSection").style.display = "none";
...
function firstAide() {
    ...
    if (firstAideSelection[0].checked) {
        ...
        document.getElementById("firstAideSection").hidden = false;
    ...
    if (firstAideSelection[1].checked) {
        ...
        document.getElementById("firstAideSection").hidden = true;
...
function eventAdvertised() {
    ...
    if (eventAdvertisedSelection[1].checked) {
        ...
        document.getElementById("eventAdvertiseSection").hidden = true;
...
function eventMainWebsite() {
    ...
    if (eventWebsiteName[0].checked) {
        ...
        document.getElementById("advertiseWebsite").hidden = false;
    ...
    if (eventWebsiteName[1].checked) {
        ...
        document.getElementById("advertiseWebsite").hidden = true;
...
function alcoholServed() {
    ...
    if (alcoholServedSelection[0].checked) {
        ...
        document.getElementById("alcoholServeSection").hidden = false;
        ...
        document.getElementById("alcoholSold").hidden = true;
        ...
        document.getElementById("alcoholEstimatedSales").hidden = false;
        ...
        document.getElementById("howManyDifferentAlcohol").hidden = false;
    ...
    if (alcoholServedSelection[1].checked) {
        ...
        document.getElementById("alcoholServeSection").hidden = true;
        ...
        document.getElementById("alcoholEstimatedSales").hidden = true;
        ...
        document.getElementById("howManyDifferentAlcohol").hidden = true;
...
function alcoholSold() {
    ...
    if (alcoholSoldSelection[0].checked) {
        ...
        document.getElementById("alcoholSold").hidden = false;
...
function vendorServeOrSellLiquor() {
    ...
    if (vendorSellAlcohol[0].checked) {
        ...
        document.getElementById("vendorLiquorSellingLiability").hidden = false;
    ...
    if (vendorSellAlcohol[1].checked) {
        ...
        document.getElementById("vendorLiquorSellingLiability").hidden = true;
...
function athleticOrRecreationalActivity() {
    ...
    if (athleticRecreationalActivity[0].checked) {
        ...
        document.getElementById("athleticRecreationActivitySection").hidden = false;
    ...
    if (athleticRecreationalActivity[1].checked) {
        ...
        document.getElementById("athleticRecreationActivitySection").hidden = true;
...
function haveMusic() {
    ...
    if (hasMusic[1].checked) {
        ...
        document.getElementById("musicSection").hidden = true;
...
function haveOwnElectricity() {
    ...
    if (ownElectricitySelection[0].checked) {
        ...
        document.getElementById("arrangementsMade").hidden = true;
        ...
        document.getElementById("electricityArrangement").hidden = true;
        document.getElementById("otherTypeOfEntertainment").style.display = "none";
    ...
    if (ownElectricitySelection[1].checked) {
        ...
        document.getElementById("arrangementsMade").hidden = false;
        ...
        document.getElementById("electricityArrangement").hidden = false;
...
function typeOfOtherEntertainment() {
    ...
    if (otherEntertainmentSelection[0].checked) {
        ...
        document.getElementById("otherTypeOfEntertainment").hidden = false;
        ...
        document.getElementById("otherEntertainmentDescription").hidden = false;
    ...
    if (otherEntertainmentSelection[1].checked) {
        ...
        document.getElementById("otherTypeOfEntertainment").hidden = true;
        document.getElementById("otherTypeOfEntertainment").style.display = "none";

        document.getElementById("otherEntertainmentDescription").disabled = true;
        document.getElementById("otherEntertainmentDescription").hidden = true;
...
function activitiesAndOthers() {
    ...
    if (activitiesStuffSelection[0].checked) {
        ...
        document.getElementById("activitiesSection").hidden = false;
    ...
    if (activitiesStuffSelection[1].checked) {
        ...
        document.getElementById("activitiesSection").hidden = true;
...
function pastEvents() {
    ...
    if (pastEventHeld[0].checked) {
        ...
        document.getElementById("previousSimilarEvents").hidden = false;
    ...
    if (pastEventHeld[1].checked) {
        ...
        document.getElementById("previousSimilarEvents").hidden = true;
...
function emergencyEvacuationPlan() {
    ...
    if (evacPlan[0].checked) {
        ...
        document.getElementById("emergencyEvacuationExplaination").hidden = false;
    ...
    if (evacPlan[1].checked) {
        ...
        document.getElementById("emergencyEvacuationExplaination").hidden = true;
...
function medicalServicePresent() {
    ...
    if (medicalPresence[0].checked) {
        ...
        document.getElementById("medicalPresent").hidden = false;
    ...
    if (medicalPresence[1].checked) {
        ...
        document.getElementById("medicalPresent").hidden = true;
...
function streetClosureNeed() {
    ...
    if (streetClosing[0].checked) {
        ...
        document.getElementById("streetClosures").hidden = false;
    ...
    if (streetClosing[1].checked) {
        ...
        document.getElementById("streetClosures").hidden = true;
...
function trafficMitigations() {
    ...
    if (trafficMitigating[0].checked) {
        ...
        document.getElementById("trafficMitigationOptions").hidden = false;
    ...
    if (trafficMitigating[1].checked) {
        ...
        document.getElementById("trafficMitigationOptions").hidden = true;
...
/*
   ...
   for (var i = 0; i < allVisibleRadioGroups.length; i++) {
       if (!allDistinctVisibleRadioGroups.includes(allVisibleRadiobuttons[i])) {
           allDistinctVisibleRadioGroups.push(allDistinctVisibleRadioGroups[i])
       }
   }

   alert("Your here 3");
   // All distinct visible radioButton groups into a string list
   var allDistinctVisibleRadioGroupsList = "";
   for (var i = 0; i < allDistinctVisibleRadioGroups.length; i++) {
       allDistinctVisibleRadioGroupsList += " " + allDistinctVisibleRadioGroups[i];
   }

   alert("Groups visible: \n" + allDistinctVisibleRadioGroupsList);
   */
