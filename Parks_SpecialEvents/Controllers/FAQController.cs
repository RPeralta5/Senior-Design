...
namespace Parks_SpecialEvents.Controllers
{
    public class FAQController : Controller
    {
        ...
        const string FAQCONNECTIONSTRING = @"Data Source=desktop-dpi5unv;Initial Catalog=parks_faqDB;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";

        // STORE QUESTIONS IN A DATABASE
        QuestionDB questionDB = new QuestionDB();

        // PARKS CONNECTION STRING
        const string PARKSCONNECTIONSTRING = @"Data Source=desktop-dpi5unv;Initial Catalog=parks_faqDB;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
